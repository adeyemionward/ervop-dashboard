    ...
    return (
        <DashboardLayout>
            <HeaderTitleCard onGoBack={handleGoBack} title="Transactions" description="Track all your income and expenses in one place.">
                <Link href="/expenses/new" className="btn-primary flex items-center gap-2 px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors">
