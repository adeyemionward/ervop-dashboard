...
export default function CreateDocModal({ onClose }: CreateDocProps) {
  ...
  // Document types
  const types = ["Proposal", "Contract", "NDA", "General"];
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
        ...
        <button
          ...
          className="bg-purple-600 text-white hover:bg-purple-700 font-semibold py-2 px-6 rounded-lg flex items-center transition-colors disabled:opacity-50"
        >
