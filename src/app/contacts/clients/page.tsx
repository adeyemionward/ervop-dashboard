...
const [contactToDelete, setContactToDelete] = useState<Contact | null>(null);
  ...
  return (
    <DashboardLayout>
      ...
      {/* SEARCH + FILTER */}
      <div className="mb-4 p-4 bg-white rounded-lg shadow-sm flex flex-wrap items-center gap-4 border border-gray-200 items-center justify-between">
        {/* Search input */}
        <input
          type="text"
         ...
         <DataTable
            columns={[
              ...
              },
              {
                ...
                actions={(contact) => (
                <>
                  <Link href={`/appointments/view/${contact.id}`} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition">
                      <Eye className="w-4 h-4 text-gray-500" /> View
                  </Link>
                  <Link href={`/appointments/edit/${contact.id}`} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition">
